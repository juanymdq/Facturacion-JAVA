		...
		<div class="form-principal">
			...
			<form action="adminPosiva?action=register" method="post">				
				<div class="form-group col-md-10" style="width:150px;">
					...
					<input class="form-control" name ="id_posiva" id="ex1" type="text" placeholder="Ingrese id">  
		  		</div>		
				<div class="form-group col-md-10" style="width:400px;">
					<label>Nombre de Posicion IVA</label>
				  	<input type="text" name="nombre_posiva" class="form-control" id="formGroupExampleInput2" placeholder="Ingrese nombre">
				</div>	
				<div class="form-group col-md-6" style="width:200px;">
					<label>Porcentaje IVA</label>
				  	<input type="text" name="porcentaje" class="form-control" id="formGroupExampleInput2" placeholder="Ingrese porcentaje">
				</div>			
